...
> **`Answer`**:
> 
>         Not needed bc local data will be given and wants to make it as easy 
>         and as simple as possible. As things progress, things will get more 
>         advanced
...
> **`Answer`**: 
> 
>         Amanda works hard has a lot to offer, but these points are going to 
>         be changing over the coming quarters. Testing will be utilized in a 
>         way that makes the site more reliable which is key, but results will 
>         be around enterprise software 
...
> **`Answer`**: 
> 
>         No, and nothing to worry about, esp in two months 
